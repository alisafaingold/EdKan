document.getElementById('addRowToWitnessesForm').onclick=function () {
    ...
    newInput2.setAttribute("id","inlineFormInputGroupUsername2");
    ...
    newInput3.setAttribute("id","inlineFormInputGroupUsername2");
    ...
    newInput4.setAttribute("id","inlineFormInputGroupUsername2");
    ...
    newInput5.setAttribute("id","inlineFormInputGroupUsername2");
    ...
    newInput6.setAttribute("id","inlineFormInputGroupUsername2");
